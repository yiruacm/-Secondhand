...
//Upload文件目录
// $APPKEY='';
// $APPKEY = $APPKEY>0 ? $APPKEY : (int)$_REQUEST['APPKEY'];
$APPKEY = 3057;
defined('__UPLOAD__')   or define('__UPLOAD__', __ROOT__.'/Data/app/'.ceil($APPKEY/50).'/'.$APPKEY.md5($APPKEY)."/");
// 上传文件夹目录，move_uploaded_file 函数，只能这样定义了  改变这里需要改一下Upload控制器里的路径
defined('__UPLOADAPP__')   or define('__UPLOADAPP__','Data/app/'.ceil($APPKEY/50).'/'.$APPKEY.md5($APPKEY)."/");
// defined('__UPLOAD__')   or define('__UPLOAD__', __ROOT__.'/Data/app/62/3057c1502ae5a4d514baec129f72948c266e/');
//Func函数目录
defined('__FUNC__')   or define('__FUNC__',     __ROOT__.'/Func');
$appkey = 3057;
$appkey = $appkey>0 ? $appkey : (int)$_REQUEST['appkey'];

//目录设置
// define('__UPLOAD-APP__','app/'.ceil($appkey/50).'/'.$appkey.md5($appkey));
//***************
